    ...
    <div>
      ...
      <div className="rounded-lg my-6">
        <h2 className="text-xl md:text-3xl font-bold text-center">
          {tutorData?.name}`s <span className="text-blue-600">Profile</span>
        </h2>
      </div>
        ...
        <div className="w-full mx-auto max-w-sm rounded-xl shadow-lg">
          <CardContent className="flex flex-col items-center pb-5">
            <div className="relative w-48 h-48">
              <Image
                src={tutorData?.image || tutorImg}
                alt="Profile"
                width={200}
                height={200}
                className="object-cover rounded-full border-full border-white"
              />
        ...
        <Tabs defaultValue="about" className="w-full mt-4">
          <TabsContent value="about">
            <div className="my-6">
              ...
              <p className="text-gray-500 mt-2">{tutorData?.bio}</p>
            </div>
            ...
            <div className="my-6">
              ...
              <h2 className="text-sm text-gray-500 mb-1 flex gap-2 font-bold mt-1">
                <PhoneCall size={18} /> {tutorData?.phone || "N/A"}
              </h2>
              <h2 className="text-sm text-gray-500 mb-1 flex gap-2 font-bold mt-1">
                <Mail size={18} /> {tutorData?.email}
              </h2>
              <h2 className="text-sm text-gray-500 font-semibold mt-1 flex gap-2">
                <MapPinHouse size={18} /> {tutorData?.address || "N/A"}
              </h2>
            </div>
          </TabsContent>
        </Tabs>
